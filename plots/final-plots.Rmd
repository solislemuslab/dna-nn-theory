...
pdf("splice-dimension-layers-acc.pdf",height=6, width=8.75)
p
dev.off()
```
...
pdf("histone-dimension-layers-acc.pdf",height=6, width=8.75)
p2
dev.off()
```
...
pdf("motif-dimension-layers-acc.pdf",height=6, width=8.75)
p3
dev.off()
```
...
pdf("splice-dimension-layers-pr.pdf",height=6, width=9)
p
dev.off()
```
...
pdf("histone-dimension-layers-pr.pdf",height=6, width=3.5)
p2
dev.off()
```
...
pdf("motif-dimension-layers-pr.pdf",height=6, width=5)
p3
dev.off()
```
...
pdf("splice-dimension-layers-roc.pdf",height=6, width=9)
p
dev.off()
```
...
pdf("histone-dimension-layers-roc.pdf",height=6, width=3.5)
p2
dev.off()
```
...
pdf("motif-dimension-layers-roc.pdf",height=6, width=5)
p3
dev.off()
```
