This is an internal file to organize output files not present in the github repo. External users should ignore this file.

# V1
All scripts in this section for version 1 can be found in `./v1_scrips` and output files in `v1_csv`.
